...
//    ImageIcon profile = new ImageIcon("sign_out.png");
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        User obj = new User();
        boolean isLogin = obj.login(email, password);
        if (isLogin) {
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(rootPane, "Account does not exist, please try again", "Error", JOptionPane.ERROR_MESSAGE);
            emailInput.setText("");
...
//                new appointmentGUI().setVisible(true);
    ...
    private ArrayList<String> appointment = new ArrayList<>();
